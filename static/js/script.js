...
const ellipsisNotes = document.querySelector(".ellipsis-notes")
const ellipsisNotesMenu = document.querySelector(".ellipsis-notes-menu")
...
if (ellipsisNotes) {
    ellipsisNotes.addEventListener("click", () => {
        ellipsisNotesMenu.classList.toggle("show");
    });
  }
